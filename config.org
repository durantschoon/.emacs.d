...
#+BEGIN_SRC emacs-lisp
  ...
  (when window-system
    ...
    (linum-mode 1)
    (find-file "/Users/durantschoon/Documents/tech_computer/emacs_notes.org")
    (split-window-right)
...
** Remember these!
   ...
   | Key Binding | Description                                |
   |-------------+--------------------------------------------|
   | H-h         | Hide a code block (my definition)          |
   | H-s         | Show a code block (my definition)          |
   | H-t         | Toggle hiding a code block (my definition) |
   |-------------+--------------------------------------------|
...
** First things I want to do:
   ...
   - Integrate my yasnippets from work
     Decide how to make them part of the repo
   - Upload to github and ensure sharing works
     - Remove the "While I'm debugging" section
     - Add "cheetsheet" reminders to this file
       see file:~/Documents/tech_computer/emacs_notes.org

       where to put notes like:

       - yasnippet 
         A variable can also have a default value which is specified
         like this: ${1:object}.
...
** What to explore next
   ...
   - Resolve all tabs issues:
     ...
     Decision is to set all my tabs to 2 by default, but maybe I
     should have yasnippets so I can set the tab to say 4

     <!-- mode: web; web-mode-markup-indent-offset: $0; -->
   ...
   - Add code from [[file:/Users/durantschoon/EMACS_BACKUP/init_work.el][work emacs dot files]]
     ...
     + install for sure next
       ...
       + [[https://github.com/vermiculus/sx.el/][StackExchange integration]]
   ...
   - OMG insane [[https://www.emacswiki.org/emacs/WebKit][WebKit in Emacs]]

     [[https://www.reddit.com/r/emacs/comments/4srze9/watching_youtube_inside_emacs_25/][Watching youtube inside Emacs 25!]]

   - Jupyter

     - [[https://github.com/gregsexton/ob-ipython][org-babel integration]] might be better than [[https://github.com/millejoh/emacs-ipython-notebook][EIN -- Emacs IPython Notebook]]
   ...
   - Practice newly learned modes
     + multiple-cursors
       Also, is this still needed?
       We'll also need to ~(require 'multiple-cusors)~ because of [[https://github.com/magnars/multiple-cursors.el/issues/105][an autoload issue]].

     + Org-mode skills
       + changing styles of headlines (ASK_DANIEL)
   ...
   - source blocks
     ...
     flycheck wigging out in elisp (and python) source blocks
    ...
    - personal cheatsheet
      + builtin
        - M-x shell-command-on-region
          aka. M-|
      + mine
        - C-M-/ 'comint-dynamic-complete-filename
