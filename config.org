...
lifted from [[https://www.reddit.com/r/emacs/comments/676r5b/how_to_stop_findfileatprompting_when_there_is_a/][reddit]]
    ...
    (let* ((name (or filename (ffap-string-at-point 'file)))
      ...
      (progn
        ...
        (if (and (not foundp) (boundp 'ffap-no-confirmation-extensions-order))
            (let ((i 0)
                  (exts ffap-no-confirmation-extensions-order))
