...
#+BEGIN_SRC emacs-lisp
  (use-package helm-etags-plus
    ...
    ;;        ("M-*" . helm-etags-plus-history) ;;list all visited tags
    ;;        ("M-," . helm-etags-plus-history-go-back) ;;go back directly
    ;;        ("M-/" . helm-etags-plus-history-go-forward)) ;;go forward directly
    :init
